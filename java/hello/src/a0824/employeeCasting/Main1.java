...
import a0821.직원관리_crud.EmployeeApp;
...
public class Main1 {
    public static void main(String[] args) {
        ...
        for(Employee emp :employees){
            totalSalary = totalSalary +  emp.calculateSalary(); //객체의 실제타임을 알아서판다.
            //(FullTime, manager, partTime 알아서 판단.)
        }
        System.out.println("전체 급여 합계: " + String.format("%,.0f",totalSalary));

         System.out.println("==== 직원 타입별 처리====");
         for(Employee emp :employees){
