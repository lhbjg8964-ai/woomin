...
public class MapEx {
    public static void main(String[] args) {
        ...
        // 값 존재 확인
        System.out.printf("90 점수 존재:" + scores.containsValue(90));
        ...
        //크기 확인
        System.out.println("맵크기" + scores.size());
        ...
        //방법 1 : KeySet() 사용
        System.out.println("--- ketSet()으로 순회 ---");
